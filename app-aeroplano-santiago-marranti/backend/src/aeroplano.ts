...
class Aeroplano {
    // Composicion: se piden obligatoriamente estas partes existentes para
    // que aeroplano pueda existir
...
//Exportamos las clases para poder usarlas en el servidor del backend
export { Aeroplano, Alas, Cubierta, Helice, TrendeAterrizaje, Turbina }
